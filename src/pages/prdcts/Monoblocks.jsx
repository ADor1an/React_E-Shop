...
function Monoblocks ({monoblocks, addToBasket}) {
    ...
    const MonoblockCards = () => {
        return (
            <div className={classes.Items}>
                ...
                <Container>
                    <main>
                        {monoblocks.map((item,index) => (
                            <MonoblockCard item={item} key={index} addToBasket={addToBasket}/>
                        ))}
                    </main>
                </Container>
            </div>
